...
public class Comercial extends Empleat {
    ...
    public Comercial(int comissio, Date dataAlta, Nomina nomina, String nom, String llinatge, Document document, String numDocument, String adreça, int telefon, String email) {
